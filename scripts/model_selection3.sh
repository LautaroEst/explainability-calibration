...
#$ -S /bin/bash
#$ -N model_selection3
#$ -o /homes/eva/q/qestienne/projects/explainability/logs/model_selection3_out.log
#$ -e /homes/eva/q/qestienne/projects/explainability/logs/model_selection3_err.log
#$ -q long.q
